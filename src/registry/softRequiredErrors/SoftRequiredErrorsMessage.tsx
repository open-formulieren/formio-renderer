...
const SoftRequiredErrorsList: React.FC<SoftRequiredErrorsListProps> = ({id, missingFields}) => (
  <>
  ...
  return (
    <>
      <DynamicFormattedMessage
        ...
        values={{
          missingFields: <SoftRequiredErrorsList id={id} missingFields={missingFields} />,
        }}
      />
    </>
  );
