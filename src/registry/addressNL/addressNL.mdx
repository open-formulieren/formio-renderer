...
A pattern can specified for the city input so that input can be restricted.

A custom validation message can be specified for this.

**Validation options for postcode**

A pattern can specified for the postcode input so that a subset of postcodes can be enforced for
