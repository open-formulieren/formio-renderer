...
// TODO-82: look into this maybe? We aim to make it accessible to assistive technology and
keyboard-only navigation. Note that it is currently not possible yet to navigate inside the calendar
